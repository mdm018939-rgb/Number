...
# ========== কনফিগ ==========
BOT_TOKEN = os.getenv("BOT_TOKEN", "8707317304:AAG8f5jjLujvMrIvet1W1nO618eegkv5Miw")
CHAT_ID = os.getenv("CHAT_ID", "-1004437460481")
COOKIES_JSON = os.getenv("COOKIES_JSON", '{"XSRF-TOKEN": "%3D", "_fbp": "fb.1.1787646534248.44647405065281422"}')
CHECK_INTERVAL = 5
...
def login():
    global csrf_token, logged_in, scraper
    scraper = cloudscraper.create_scraper()
